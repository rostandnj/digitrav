 ...
 */
final class Version20190326195637 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD rpassword VARCHAR(255) DEFAULT NULL, CHANGE date date DATETIME NOT NULL, CHANGE activation_date activation_date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE role CHANGE date date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE statut CHANGE date date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user DROP rpassword, CHANGE date date DATETIME NOT NULL, CHANGE activation_date activation_date DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user_detail CHANGE date date DATETIME NOT NULL');
    }
}
