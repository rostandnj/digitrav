 ...
 */
final class Version20190319145453 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE account_validation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, date DATETIME NOT NULL, statut TINYINT(1) NOT NULL, type INT NOT NULL, last_date DATETIME NOT NULL, INDEX IDX_EA37A9CAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE account_validation ADD CONSTRAINT FK_EA37A9CAA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
