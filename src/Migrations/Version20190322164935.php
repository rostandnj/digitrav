 ...
 */
final class Version20190322164935 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_detail ADD cv_id INT DEFAULT NULL, ADD description LONGTEXT DEFAULT NULL, CHANGE date date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user_detail ADD CONSTRAINT FK_4B5464AECFE419E2 FOREIGN KEY (cv_id) REFERENCES file (id)');
        $this->addSql('CREATE INDEX IDX_4B5464AECFE419E2 ON user_detail (cv_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE statut CHANGE date date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user CHANGE date date DATETIME NOT NULL, CHANGE activation_date activation_date DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE user_detail DROP FOREIGN KEY FK_4B5464AECFE419E2');
        $this->addSql('DROP INDEX IDX_4B5464AECFE419E2 ON user_detail');
        $this->addSql('ALTER TABLE user_detail DROP cv_id, DROP description, CHANGE date date DATETIME NOT NULL');
    }
}
