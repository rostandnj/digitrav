 ...
 */
final class Version20190322103342 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE account_validation ADD validator_id INT DEFAULT NULL, CHANGE date date DATETIME NOT NULL, CHANGE last_date last_date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE account_validation ADD CONSTRAINT FK_EA37A9CAB0644AEC FOREIGN KEY (validator_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_EA37A9CAB0644AEC ON account_validation (validator_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE account_validation DROP FOREIGN KEY FK_EA37A9CAB0644AEC');
        $this->addSql('DROP INDEX IDX_EA37A9CAB0644AEC ON account_validation');
        $this->addSql('ALTER TABLE account_validation DROP validator_id, CHANGE date date DATETIME NOT NULL, CHANGE last_date last_date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE bill CHANGE date date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE category CHANGE date date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE company CHANGE date date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE domain CHANGE date date DATETIME NOT NULL');
